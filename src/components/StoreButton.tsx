...
const StoreButton = ({ store, variant = "default" }: StoreButtonProps) => {
  ...
  if (store === "apple") {
    return (
      <a
        href="#"
        className={`inline-flex items-center gap-3 rounded-lg px-5 py-3 transition-opacity hover:opacity-90 ${
          isInverted
  ...
  return (
    <a
      href="#"
      className={`inline-flex items-center gap-3 rounded-lg border-2 px-5 py-3 transition-colors ${
        isInverted
